    ...
    return (
      <div className="not-prose flex flex-col">
        {tab === 'code' && (
          <pre
            {...props}
            className={`text-sm w-full overflow-x-auto dark:bg-zinc-900 p-4 border border-zinc-200 dark:border-zinc-700 rounded-xl dark:text-zinc-50 text-zinc-900 font-['geist-mono']`}
          >
            <code className="whitespace-pre-wrap break-words font-['geist-mono']">{children}</code>
          </pre>
        )}

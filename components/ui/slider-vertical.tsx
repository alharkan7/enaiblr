...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    className={cn(
      'relative flex h-full touch-none select-none flex-col justify-center',
      className
    )}
    {...props}
  >
    <SliderPrimitive.Track className="relative w-2 h-full grow overflow-hidden rounded-full bg-secondary">
      <SliderPrimitive.Range className="absolute w-full bg-primary data-[orientation=vertical]:w-full" />
